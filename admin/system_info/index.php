...
<div class="col-lg-12">
	<div class="card card-outline card-purple rounded-0 shadow">
		<div class="card-header">
			<h5 class="card-title">Information sur le système</h5>
		...
		<div class="card-body">
			...
			<div class="form-group">
				<label for="short_name" class="control-label">Nom court du système</label>
				<input type="text" class="form-control form-control-sm" name="short_name" id="short_name" value="<?php echo  $_settings->info('short_name') ?>">
			</div>
			<div class="form-group">
				<label for="" class="control-label">A propos de noum</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Couverture de site web</label>
				<div class="custom-file">
	              <input type="file" class="custom-file-input rounded-circle" id="customFile" name="cover" onchange="displayImg2(this,$(this))">
	              <label class="custom-file-label" for="customFile">Choisir un fiechier</label>
	            </div>
			</div>
			<div class="form-group d-flex justify-content-center">
		...
		<div class="card-footer">
			<div class="col-md-12">
				<div class="row">
					<button class="btn btn-sm btn-success" form="system-frm">Mettre à jour les paramétres</button>
				</div>
			</div>
		</div>
